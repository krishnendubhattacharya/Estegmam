...
/*	    $_SESSION['user_email']=$email;
		...
		<img src="http://homevacationclub.com/images/logo.png" alt="" border="0" />
...
$TemplateMessage.="<br>";
		...
		$TemplateMessage.="Please <a href='http://homevacationclub.com/activate.php?id=".base64_encode($email)."'>Click Here</a> to activate your account";

		$TemplateMessage.="<br><br><br/>Thanks & Regards<br/>";

		$TemplateMessage.="Home Vacation Club";
		...
		$mail1->FromName = "Home Vacation Club";

		$mail1->From    = "info@homevacationclub.com";
		...
		$mail1->AddAddress($email,"info@homevacationclub.com");//info@salaryleak.com
 ...
 if($_REQUEST['action']=='accountUpdate')
{
 ...
 if($_REQUEST['action']=='accountPasswordUpdate')
{

	$newpass = isset($_POST['newpass']) ? $_POST['newpass'] : '';
	$fields = array(
		'password' => mysql_real_escape_string(md5($newpass)));
...
if($_REQUEST['action']=='saveDeal')
{
	...
	$fields = array(
		'deal_price' => mysql_real_escape_string($deal_price),
	 ...
	 $editQuery = "UPDATE `vacation_property` SET " . implode(', ', $fieldsList)
          . " WHERE `id` = '" . mysql_real_escape_string($prop_id) . "'";
