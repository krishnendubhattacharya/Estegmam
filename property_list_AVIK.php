                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            while ($amenities = mysql_fetch_array($ame)) {
                                                ...
                                                <div class="col-sm-6 padding_left_right">
                                                    <div class="fromgroup_check"><span><?php echo $amenities['name'] ?></span><input type="checkbox" name="proptype[]" value="<?php echo $amenities['id'] ?>" onclick="proptypechange('<?php echo $amenities['id'] ?>')"></div></div>
                                                <?php
                                            }
                                            ?>
                                        </div>
...
{lat: <?php echo $result->lat; ?>,lng: <?php echo $result->lng; ?>,name: "<?php echo $result->name; ?>",image: "<?php echo $image; ?>", id: "<?php echo $result->id; ?>"},
    <?php } else { ?>
{lat: <?php echo $result->lat; ?>,lng: <?php echo $result->lng; ?>,name: <?php echo $result->name; ?>,image: "<?php echo $image; ?>",id: "<?php echo $result->id; ?>"}
        <?php
    }
