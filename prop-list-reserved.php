...
if (isset($_REQUEST['del']) && $_REQUEST['del'] != '') {
    ...
    $_SESSION['MSG'] = 1;
    header("location:prop-list-reserved.php");
    exit();
}
?>
<html lang="en">
    <head>
        ...
        <script type="text/javascript">
            function ConfirmDelete(val)
            {
                ...
                if (sss)
                {
                    document.location.href = "prop-list-reserved.php?del=" + val;
                }
            }
        </script>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-9">
                        <div class="row">
                            <ul class="poplist">
                                <?php
                                $prop_booking = mysql_query("select * from `estejmam_booking` where `user_id`='" . $_SESSION['userid'] . "' and `status`='1'");
