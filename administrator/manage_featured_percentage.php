...
include_once("includes/functions.php");
		 ...
		 //$pid=$_REQUEST['id'];
		$sql2="SELECT * FROM `estejmam_featured_amount` where id='1'"; 
...
if(isset($_REQUEST['submit']))
	{ 
	 ...
	 $editQuery = "UPDATE `estejmam_featured_amount` SET " . implode(', ', $fieldsList)
			. " WHERE `id` = '1'";
		...
		header('Location: manage_featured_percentage.php');
		exit();
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Manage Property Featured Amount</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" method="post" action="manage_featured_percentage.php">
                                      <fieldset>
                                        <legend>Manage Property Featured Amount</legend>
