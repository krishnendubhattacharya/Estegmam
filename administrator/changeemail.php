...
if(isset($_REQUEST['submit']))
	{
	 ...
	 $fields = array('email' => mysql_real_escape_string($email));
	   $fieldsList = array();
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" method="post" action="changeemail.php">
                                      <fieldset>
                                        <legend>Change Email Address</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Email Address</label>
                                          <div class="controls">
                      <input name="email" class="input-xlarge focused" required id="focusedInput" type="text" value="<?php echo $row['email'];?>">
                                          </div>
                                        </div>
