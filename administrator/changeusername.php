...
$fields = array('admin_username' => mysql_real_escape_string($in_user2));
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Change Username</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" method="post" action="changeusername.php">
                                      <fieldset>
                                        <legend>Change Username</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Username</label>
                                          <div class="controls">
                      <input name="in_user2" class="input-xlarge focused" required id="focusedInput" type="text" value="<?php echo $row['admin_username'];?>">
                                          </div>
                                        </div>
