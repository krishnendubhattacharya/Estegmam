...

{
	...
	mysql_query("delete from  estejmam_social where id='".$item_id."'");
...

{
	 ...
	 mysql_query("update estejmam_social set status='0' where id='".$item_id."'");
...

{
	...
	mysql_query("update estejmam_social set status='1' where id='".$item_id."'");
...
$sql="select * from estejmam_social  where id<>''";
                  ...
                  <div class="row-fluid">
                        ...
                        <div class="block">
                            ...
                            <div class="navbar navbar-inner block-header">
                                ...
                                <div class="muted pull-left">List Category</div>
...
?>
						                ...
						                <tr>
                                          ...
                                          <td align="center"><?php echo stripslashes($row->link);?></td>

                                          <td>

                                           <?php /*?><?php if($row->status=='0'){?>
...
<button class="btn btn-mini"  onClick="javascript:inactive('<?php echo $row->id;?>');">Deactivate</button>
		  ...
		  <?php }?>&nbsp;<button class="btn btn-mini"  onClick="javascript:del('<?php echo $row->id; ?>')">Delete</button>&nbsp;<?php */?><button class="btn btn-mini" onClick="window.location.href='add_social.php?id=<?php echo $row->id ?>&action=edit'">Edit</button></td>
