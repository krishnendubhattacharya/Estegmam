...
$sql = "select * from estejmam_user  where id<>'' AND `type`='0'";
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">List User</div>
                            </div>
                                            ...
                                            if (mysql_num_rows($record) == 0) {
                                                ...
                                                while ($row = mysql_fetch_object($record)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><button class="btn btn-mini"  onClick="javascript:del('<?php echo $row->id; ?>')">Delete</button>&nbsp;


                                                            <?php if ($row->status == '1') { ?>
                                                                <button class="btn btn-mini"  onClick="javascript:inactive('<?php echo $row->id; ?>');">Block User</button>
                                                            <?php } else { ?>
                                                                <button class="btn btn-mini"  onClick="javascript:active('<?php echo $row->id; ?>');">Un Block User</button>
                                                            <?php } ?>&nbsp;<button class="btn btn-mini" onClick="window.location.href = 'user_details.php?id=<?php echo $row->id ?>&action=details'">Details</button>&nbsp;
