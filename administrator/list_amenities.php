...
$sql = "select * from `estejmam_amenities` where id<>''";
                                            ...
                                            if (mysql_num_rows($record) == 0) {
                                                ...
                                                while ($row = mysql_fetch_object($record)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button class="btn btn-mini" onClick="window.location.href = 'add_amenities.php?id=<?php echo $row->id ?>&action=edit'">Edit</button></td>
                                                    </tr>
                                                    <?php
                                                    $count++;
                                                }
