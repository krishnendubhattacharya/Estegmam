...
if(isset($_REQUEST['submit']))
	{
	 ...
	 $fields = array('paypal_email' => mysql_real_escape_string($paypal_email));
	   $fieldsList = array();
                    ...
                    <div class="row-fluid">
                        ...
                        <div class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Change Email Address</div>
                            </div>
                            <div class="block-content collapse in">
                                <div class="span12">
                                     <form class="form-horizontal" method="post" action="changepaypal_email.php">
                                      <fieldset>
                                        <legend>Change Paypal Email Address</legend>
                                        <div class="control-group">
                                          <label class="control-label" for="focusedInput">Email Address</label>
                                          <div class="controls">
                      <input name="paypal_email" class="input-xlarge focused" required id="focusedInput" type="text" value="<?php echo $row['paypal_email'];?>">
                                          </div>
                                        </div>
